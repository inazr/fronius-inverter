...
SELECT
        ...
        SAFE_CAST(Body_Data_Site_P_Akku AS NUMERIC)             AS akku_volt,
        SAFE_CAST(Body_Data_Site_P_Grid AS NUMERIC)             AS grid_volt,
        SAFE_CAST(Body_Data_Site_P_Load AS NUMERIC)             AS load_volt,
        SAFE_CAST(Body_Data_Site_P_PV AS NUMERIC)               AS pv_volt,
